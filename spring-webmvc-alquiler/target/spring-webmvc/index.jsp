...
-->
  ...
  <script src="js/bootstrap.min.js"></script>
        ...
        <div class="container">
          ...
          <div class="nav-collapse collapse">
            <ul class="nav">
				...
				<li><a href="buscarusuario.jsp"><i class="icon-user"></i> Usuario</a></li>
    ...
    <div class="container">
	  ...
	  <div id="welcome-carousel" class="carousel slide"><!-- class of slide for animation -->
          <div class="carousel-inner">
            ...
            <div class="item">
              <img src="images/drums.jpg" alt="" width="400" height="400"/>
			  <div class="carousel-caption">
                <p>Drums!</p>
              </div>
            </div>
            <div class="item">
              <img src="images/2nd.jpg" alt="" width="350" height="350"/>
              <div class="carousel-caption">
                <p>Second Guitar!</p>
              </div>
            </div>
            <div class="item">
              <img src="images/console.jpg" alt="" width="350" height="350"/>
			  <div class="carousel-caption">
                <p>Dj Console!</p>
              </div>
            </div>
			<div class="item">
              <img src="images/saxofon.jpg" alt="" width="400" height="400"/>
			  <div class="carousel-caption">
                <p>Saxophone!</p>
              </div>
            </div>
    ...
    <script javascript="javascript/jquery.js"></script>
    <script javascript="javascript/bootstrap-transition.js"></script>
    <script javascript="javascript/bootstrap-alert.js"></script>
    <script javascript="javascript/bootstrap-modal.js"></script>
    <script javascript="javascript/bootstrap-dropdown.js"></script>
